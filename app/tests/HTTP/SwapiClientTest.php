...
final class SwapiClientTest extends TestCase
{
    ...
    public function testCanReturnPopperResponse(string $validJsonResponse, string $nextJson): void
    {
        $response = \Mockery::mock(ResponseInterface::class);
        $response->shouldReceive('getContent')
            ->andReturn($validJsonResponse);
        $nextResponse = \Mockery::mock(ResponseInterface::class);
        $nextResponse->shouldReceive('getContent')
            ->andReturn($nextJson);
